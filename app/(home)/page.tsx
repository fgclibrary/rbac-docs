...
// 框架特性列表
const features = [
  { icon: Zap, title: "开箱即用", description: "模块引入即用，零开发成本启用标准权限能力" },
  {
    icon: Layers,
    title: "标准化实践",
    description: "基于官方最佳实践设计，确保架构先进性与可维护性",
  },
  { icon: Boxes, title: "事件驱动", description: "组件级事件机制，精准管控功能模块内部流转" },
  { icon: Eye, title: "模板复用", description: "组件、页面、样式均可抽离为模板进行沉淀复用" },
  { icon: Plug, title: "开放接口", description: "标准 API 全覆盖，支持自定义前端与自动化集成" },
];
    ...
    <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-screen-xl flex-col items-center justify-center px-6 py-24 lg:flex-row lg:gap-24">
      ...
      <section className="flex flex-col text-left lg:basis-[55%]">
        <h1 className="font-bold text-4xl leading-tight tracking-tight sm:text-5xl">
          {appName}
          <br />
          <span className="text-muted-foreground text-3xl sm:text-4xl">活字格标准化权限管理框架</span>
        </h1>
